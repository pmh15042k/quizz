            ...
            <div class="row">
                <div class="section-1 ">
                    ...
                    <div class="section-1_btn">
                        ...
                        <a href="" class="section-1_btn--bg_white"><i class="fa-solid fa-caret-down"></i>know more</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="section-2">
                    ...
                    <div class="section-2_main row">
                        ...
                        <div class="item--wrapper">
                            <div class="item">
                                <img src="{{ asset('/template/img/Group 23.png') }}" class="  item_icon">
                            ...
                            <div class="item">
                                <img src="{{ asset('/template/img/Group 24.png') }}" class="  item_icon">
                                <div class="item_head">
                                    Plenty of subjects
                                </div>
                                <div class="item_sub">
                                    Plenty of subjects to choose from for e.g. Computer languages, Engineering subjects etc.
                                </div>
                            </div>
                            <div class="item">
                                <img src="{{ asset('/template/img/Group 25.png') }}" class="item_icon">
                                <div class="item_head">
                                    Detailed solutions
                                </div>
                                <div class="item_sub">
